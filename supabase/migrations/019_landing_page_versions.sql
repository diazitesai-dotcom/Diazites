-- Landing page versions + editor columns (required for AI funnel generator).
...
create unique index if not exists idx_landing_page_analytics_unique
...
drop policy if exists "landing_page_versions public read published" on landing_page_versions;
