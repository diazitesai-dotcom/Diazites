...
export function CeoCommandCenterShell({ children }: CeoCommandCenterShellProps) {
  return (
    <div className="ceo-command-center flex min-h-screen overflow-x-hidden bg-[#050810] text-slate-100">
      ...
      <Sidebar />
      <div className="relative flex min-w-0 flex-1 flex-col overflow-x-hidden pb-24 pt-16 md:pb-0 md:pt-0">
        {children}
      </div>
    </div>
  );
